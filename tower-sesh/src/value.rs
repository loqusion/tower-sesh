...
/// implementation. TODO: Discuss deserialization
///
...
/// self-describing data format for storage, not just JSON. See TODO
///
...
pub(crate) fn from_value_borrowed<'de, T>(value: &'de Value) -> Result<T, Error>
where
    T: Deserialize<'de>,
{
    T::deserialize(value)
